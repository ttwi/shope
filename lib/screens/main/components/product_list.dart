...
//  final SwiperController swiperController = SwiperController();
  ...
  Widget build(BuildContext context) {
    ...
    return SizedBox(
      height: cardHeight,
      child: Text("SWEEPER SHOULD BE HERE"),
    );
    //  Swiper(
    //   itemCount: products.length,
    //   itemBuilder: (_, index) {
    //     return ProductCard(height: cardHeight, width: cardWidth, product: products[index]);
    //   },
    //   scale: 0.8,
...
class ProductCard extends StatelessWidget {
  ...
  const ProductCard({Key? key, required this.product, required this.height, required this.width}) : super(key: key);
