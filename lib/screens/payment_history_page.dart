                          ...
                          child: DropdownButton(
                            items: <String>[
                              ...
                              return DropdownMenuItem<String>(
                                value: val,
                                child: Container(color: Colors.white, child: Align(alignment: Alignment.center, child: Text(val))),
                              );
                            }).toList(),
                            onChanged: (val) {
                              setState(() {
                                                                  ...
                                                                  Column(
                                                                    children: <Widget>[
                                                                      ...
                                                                      Padding(
                                                                        ...
                                                                        child: Text('2:00 am', style: TextStyle(fontSize: 12, color: Colors.grey)),
                                                                      )
                                                                    ],
                                                                  ),
                                                                ],
